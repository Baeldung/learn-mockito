...
class DefaultTaskServiceUnitTest {
    ...
    void givenATaskWithId6_whenFindById_thenTaskRetrieved() {
        ...
        when(mockedTaskService.findById(6L))
    ...
    void givenATaskWithId7_whenFindById_thenTaskRetrieved() {
        ...
        when(taskRepository.findById(7L)).thenReturn(optionalMockedTask);
        when(optionalMockedTask.get()).thenReturn(mockedTask); // anti-pattern
